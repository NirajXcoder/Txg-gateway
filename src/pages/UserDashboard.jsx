...
export default function UserDashboard({
  ...
  // Logged-in user ke actual transactions count karein
  const userTxnCount = (transactions || []).filter((t) => {
    if (!currentUser) return false;
    return (
      (currentUser.id && t.userId === currentUser.id) ||
      (currentUser.telegramId && t.telegramId === currentUser.telegramId) ||
  ...
  return (
    <div className="space-y-5 pb-8 animate-in fade-in duration-200">
      ...
      {/* 1. Available Balance Glossy Gradient Card */}
      ...
      {/* 2. Stat Cards Row (Live User Count) */}
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <p className="text-xl font-extrabold text-white">{userTxnCount}</p>
